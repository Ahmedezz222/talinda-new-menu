...
const imageFiles = [
  ...
  "White Rice.png",
  "7 Up.png",
  "Banana With Milk.png",
  "Birell.png",
  "Cappuccino Large.png",
  "Cappuccino Medium.png",
  "Cocktail Herbs.png",
  "Cortado.png",
  "Espresso Double.png",
  "Espresso Single.png",
  ...
  "Ice Latte.png",
  "Ice Mocha.png",
  "Ice Pistachio Latte.png",
  "Ice Spanish Latte.png",
  "Ice Tea Lemon.png",
  "Ice Tea Passion.png",
  "Ice Tea Peach.png",
  "Ice White Mocha.png",
  "Latte Mocha.png",
  "Latte White Mocha.png",
  "Latte.png",
  "Lemon Mint.png",
  "Macchiato Double.png",
  "Macchiato Single.png",
  "Mango.png",
  "Mix Of Friends.png",
  "Mix Of Lovers.png",
  "Mix Ramadan.png",
  "Mix The Mix.png",
  "Mocha Frappe.png",
  "Mojito Blueberry.png",
  "Mojito Classic.png",
  "Mojito Passion.png",
  "Mojito Peach.png",
  "Mojito Pineapple.png",
  "Mojito Redbull.png",
  "Mojito Strawberry.png",
  "Orange.png",
  "Passion Lemonte.png",
  "Pepsi.png",
  "Pink Lemonte.png",
  "Pistachio Frappe.png",
  "Redbull.png",
  "Sahlab.png",
  "Smoothie Blueberry.png",
  "Smoothie Guava.png",
  "Smoothie Lemon Mint.png",
  "Smoothie Mango Passion.png",
  "Smoothie Mango Peach.png",
  "Smoothie Mango.png",
  "Smoothie Pinacolada.png",
  "Smoothie Strawberry.png",
  "Spanish Latte Frappe.png",
  "Spanish Latte.png",
  "Strawberry Lemonte.png",
  "Strawberry.png",
  "Tea.png",
  "Turkish Coffee Double.png",
  "Turkish Coffee Single.png",
  "Water L.png",
  "Water S.png",
  "White Mocha Frappe.png",
  "Milk Shake Vanilla.png",
  "Milk Shake Chocolate.png",
  "Milk Shake Strawberry.png",
  "Milk Shake Mango.png",
  "Milk Shake Passion.png",
  "Milk Shake Peach.png",
  "Milk Shake Oreo.png",
  "Milk Shake Pistachio.png",
  "Molten Cake Ice Cream.png",
  "Cheesecake.png",
  "Umm Ali.png",
  "2 Scoop Ice Cream.png",
  "Fruit Plate.png",
  "Fruit Salad.png",
  "Mango Nutella Kunafa.png",
  "Helw Sharqi.png",
  "MASEL.png",
  "SPICHEAL.png",
  "LAI.png",
